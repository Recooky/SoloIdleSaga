...
window.EQUIP_LIB = {
    ...
    helmet: [
        ...
        {ilvl:[31,40],name:"岩纹战盔",base:{hp:300,dodge:48}},
        {ilvl:[41,50],name:"熔岩战盔",base:{hp:425,dodge:68}},
        {ilvl:[51,60],name:"符文战盔",base:{hp:575,dodge:92}},
        {ilvl:[61,70],name:"幽魂战盔",base:{hp:800,dodge:125}},
        {ilvl:[71,80],name:"地狱战盔",base:{hp:1050,dodge:160}},
        {ilvl:[81,90],name:"虚空战盔",base:{hp:1375,dodge:200}},
        {ilvl:[91,100],name:"深渊战盔",base:{hp:1750,dodge:245}},
        {ilvl:[101,110],name:"湮灭战盔",base:{hp:2150,dodge:290}},
        {ilvl:[111,120],name:"星界战盔",base:{hp:2600,dodge:345}}
    ],
    armor: [
        {ilvl:[1,10],name:"粗布护甲",base:{hp:120,def:18}},
        {ilvl:[11,20],name:"皮革甲胄",base:{hp:220,def:32}},
        {ilvl:[21,30],name:"铁制战甲",base:{hp:380,def:55}},
        {ilvl:[31,40],name:"岩纹战甲",base:{hp:600,def:85}},
        {ilvl:[41,50],name:"熔岩战甲",base:{hp:850,def:120}},
        {ilvl:[51,60],name:"符文战甲",base:{hp:1150,def:165}},
        {ilvl:[61,70],name:"幽魂战甲",base:{hp:1600,def:220}},
        {ilvl:[71,80],name:"地狱战甲",base:{hp:2100,def:285}},
        {ilvl:[81,90],name:"虚空战甲",base:{hp:2750,def:360}},
        {ilvl:[91,100],name:"深渊战甲",base:{hp:3500,def:440}},
        {ilvl:[101,110],name:"湮灭战甲",base:{hp:4300,def:520}},
        {ilvl:[111,120],name:"星界战甲",base:{hp:5200,def:620}}
    ],
    pants: [
        ...
        {ilvl:[51,60],  name:"符文腿铠", base:{def:310}},
        {ilvl:[61,70],  name:"幽魂腿铠", base:{def:420}},
        {ilvl:[71,80],  name:"地狱腿铠", base:{def:550}},
        {ilvl:[81,90],  name:"虚空腿铠", base:{def:700}},
        {ilvl:[91,100], name:"深渊腿铠", base:{def:860}},
        {ilvl:[101,110],name:"湮灭腿铠", base:{def:1020}},
        {ilvl:[111,120],name:"星界腿铠", base:{def:1200}}
    ],
    glove: [
        {ilvl:[1,10],   name:"粗布手套", base:{hp:40, dodge:8}},
        {ilvl:[11,20],  name:"皮革手套", base:{hp:80, dodge:14}},
        {ilvl:[21,30],  name:"铁制护手", base:{hp:140, dodge:24}},
        {ilvl:[31,40],  name:"岩纹护手", base:{hp:220, dodge:38}},
        {ilvl:[41,50],  name:"熔岩护手", base:{hp:320, dodge:54}},
        {ilvl:[51,60],  name:"符文护手", base:{hp:440, dodge:74}},
        {ilvl:[61,70],  name:"幽魂护手", base:{hp:600, dodge:100}},
        {ilvl:[71,80],  name:"地狱护手", base:{hp:800, dodge:130}},
        {ilvl:[81,90],  name:"虚空护手", base:{hp:1050, dodge:165}},
        {ilvl:[91,100], name:"深渊护手", base:{hp:1350, dodge:205}},
        {ilvl:[101,110],name:"湮灭护手", base:{hp:1700, dodge:245}},
        {ilvl:[111,120],name:"星界护手", base:{hp:2100, dodge:295}}
    ],
    boot: [
        {ilvl:[1,10],name:"粗布短靴",base:{def:8,dodge:8}},
        {ilvl:[11,20],name:"皮革长靴",base:{def:14,dodge:14}},
        {ilvl:[21,30],name:"铁制战靴",base:{def:24,dodge:24}},
        {ilvl:[31,40],name:"岩纹战靴",base:{def:38,dodge:38}},
        {ilvl:[41,50],name:"熔岩战靴",base:{def:54,dodge:54}},
        {ilvl:[51,60],name:"符文战靴",base:{def:74,dodge:74}},
        {ilvl:[61,70],name:"幽魂战靴",base:{def:100,dodge:100}},
        {ilvl:[71,80],name:"地狱战胫",base:{def:130,dodge:130}},
        {ilvl:[81,90],name:"虚空战胫",base:{def:165,dodge:165}},
        {ilvl:[91,100],name:"深渊战靴",base:{def:205,dodge:205}},
        {ilvl:[101,110],name:"湮灭战靴",base:{def:245,dodge:245}},
        {ilvl:[111,120],name:"星界战靴",base:{def:295,dodge:295}}
    ],
    ring: [
